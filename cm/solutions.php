...
<h2>AVS Solutions Management:</h2>
</div>
</div>
<div class='row'>
...
<div class='row'>
   ...
   <div class='col-sm-12 col-md-5 col-md-push-1'>
      <textarea name='solutiontext' style='height:300px;' class='form-control'><?php if(isset($soltext)) {echo $soltext;} ?></textarea>
   </div>
</div>
<div class='row'>
